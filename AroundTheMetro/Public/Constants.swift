...
//    static let API_URL_DEVELOPMENT = NSLocalizedString("\(API_URL_BASE)\(Public.CountryName)/\(Public.CityName)", comment: "myurl")
    ...
    static let titles = ["Home","My Profile","Change City", "Smiley Feedback", "Contact us"]
    static let titlesImages: [String] = ["home-icon", "profile-icon","city-icon", "feedback-icon", "contactus-icon"]
